...
def create_slide4(prs: Presentation, slide4_data):
    ...
    table1 = slide.shapes.add_table(table1_rows, table1_cols, table_left, Inches(1.2), max_table_width, Inches(3.8)).table
    ...
    table2 = slide.shapes.add_table(table2_rows, table2_cols, table_left, Inches(5.6), max_table_width, Inches(2.4)).table
