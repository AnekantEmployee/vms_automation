...
def create_slide7(prs: Presentation, slide7_data):
    ...
    table_height = Inches(0.4 + (total_rows * 0.3))  # Header + rows
    table = slide.shapes.add_table(total_rows, cols, table_left, table_top, max_table_width, table_height).table
    ...
    for i in range(1, total_rows):
        table.rows[i].height = Inches(0.3)  # Data and total rows
