...
def create_slide6(prs: Presentation, slide6_data):
    ...
    table1 = slide.shapes.add_table(stage1_rows, stage1_cols, stage1_left, Inches(1.2), stage1_width, Inches(2.0)).table
    ...
    footnote_box = slide.shapes.add_textbox(stage1_left, Inches(3.3), stage1_width, Inches(0.2))
    ...
    table2 = slide.shapes.add_table(stage2_rows, stage2_cols, stage1_left, Inches(4.2), stage1_width, Inches(2.0)).table
